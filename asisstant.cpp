...
void store_Iphone(Iphone &I13p,Iphone &I13,Iphone &I14,Iphone &I14p,Iphone &I15,Iphone &I15p,Iphone &I15pm)
{
...
{
public :
void store_Samsung(Samsung &F15,Samsung &F54,Samsung &S24,Samsung &M14,Samsung &A03,Samsung &A35,Samsung &A55)
{
...
{
 public :
 void store_Realme(Realme &C53,Realme &X50,Realme &N60,Realme &R12,Realme &R2,Realme &GT,Realme & N53)
{
C53.name="Realme C53";
C53.price=10500;
C53.camera=108;
...
{
    public :
    void store_Oppo(Oppo &A59,Oppo &A18,Oppo &N2,Oppo &A11,Oppo &N3,Oppo &A10,Oppo &F21)
{
A59.name="Oppo A59";
A59.price=15499;
A59.camera=12;
...
{
public :
void store_Redmi(Redmi &X7,Redmi &X12,Redmi &X11,Redmi &X13,Redmi &X10,Redmi &X15,Redmi & X5)
{
...
cout<<"Rear Camera : "<<obj.camera<<" MP"<<endl;
cout<<"Display Type : "<<obj.display_type<<"("<<obj.display_size<<" Inch)"<<endl;
